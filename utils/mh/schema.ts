    ...
    CuerpoDocumento: {
      ...
      items: {
        ...
        properties: {
          ...
          tipoItem: { type: 'integer', enum: [1, 2, 3, 4, 5] },
          ...
          tributos: {
            type: 'array',
            items: { type: 'string', pattern: '^(20|57|A6|A8|D4|D5|C1|C2|C3|C4)$' },
          },
          numeroDocumento: { type: ['string', 'null'], maxLength: 30 },
          codTributo: { type: ['string', 'null'], pattern: '^(20|57|A6|A8|D4|D5|C1|C2|C3|C4)$' },
      ...
      properties: {
        ...
        tributos: {
          ...
          items: {
            ...
            properties: {
              codigo: { type: 'string', pattern: '^(20|57|A6|A8|D4|D5|C1|C2|C3|C4)$' },
      ...
      properties: {
        identificacion: {
          ...
          properties: {
            ...
            numeroControl: { type: 'string', pattern: '^DTE-01-[A-F0-9]{8}-\\d{15}$' },
      ...
      properties: {
        identificacion: {
          ...
          properties: {
            ...
            numeroControl: { type: 'string', pattern: '^DTE-03-[A-F0-9]{8}-\\d{15}$' },
            codigoGeneracion: { $ref: '#/definitions/UUID' },
            tipoModelo: { type: 'integer', enum: [1, 2] },
            tipoOperacion: { type: 'integer', enum: [1, 2] },
            tipoContingencia: { type: ['integer', 'null'], enum: [1, 2, 3, 4, 5, null] },
      ...
      properties: {
        identificacion: {
          ...
          properties: {
            ...
            numeroControl: { type: 'string', pattern: '^DTE-11-[A-F0-9]{8}-\\d{15}$' },
            codigoGeneracion: { $ref: '#/definitions/UUID' },
            tipoModelo: { type: 'integer', enum: [1, 2] },
            tipoOperacion: { type: 'integer', enum: [1, 2] },
            tipoContingencia: { type: ['integer', 'null'], enum: [1, 2, 3, 4, 5, null] },
